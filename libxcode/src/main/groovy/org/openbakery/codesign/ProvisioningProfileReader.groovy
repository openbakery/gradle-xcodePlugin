...
class ProvisioningProfileReader {
	...
	void extractEntitlements(File entitlementFile, String bundleIdentifier, List<String> keychainAccessGroups, Configuration configuration) {
		...
		def entitlementsHelper = new EntitlementsHelper(getApplicationIdentifierPrefix(), getTeamIdentifierPrefix(), plistHelper)
		entitlementsHelper.update(entitlementFile, bundleIdentifier, keychainAccessGroups, configuration)
