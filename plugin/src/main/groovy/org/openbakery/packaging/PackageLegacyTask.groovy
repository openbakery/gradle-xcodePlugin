...
class PackageLegacyTask extends AbstractDistributeTask {
	...
	public static final String NAME = "packageLegacy"
	...
	PackageLegacyTask() {
		...
		onlyIf(new Spec<Task>() {
			...
			boolean isSatisfiedBy(Task task) {
				return getXcodeExtension().getType() == Type.watchOS ||
						getXcodeExtension().getType() == Type.macOS
			}
		})

		output = services.get(StyledTextOutputFactory).create(PackageLegacyTask)
